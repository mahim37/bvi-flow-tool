...
export function AddQuestion({ graph, onAdded }: AddQuestionProps) {
  ...
  return (
    ...
    >
      <summary>
        <span className="diagnostics__label">Add a question</span>
      </summary>
      ...
      >
        ...
        <button
          ...
          type="submit"
          disabled={addQuestion.isPending || code.trim() === "" || prompt.trim() === ""}
        >
          {addQuestion.isPending ? "Adding…" : "Add question"}
        </button>

        <p className="panel__hint">
          Added last, and unreachable until an edge points at it. Use the detail panel
          of the question it should follow to add that edge, and the position controls
          there to move it.
        </p>
      </form>
